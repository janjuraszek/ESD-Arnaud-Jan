...
int main () {
  ...
  while(1) {
    ...
    asm volatile ("l.nios_rrr r0,r0,%[in2],0xC"::[in2]"r"((7<<8) | 7));
    ...
    for (int line = 0; line < camParams.nrOfLinesPerImage; line++) {
      for (int pixel = 0; pixel < camParams.nrOfPixelsPerLine; pixel++) {
        ...
        */
        ...
        asm volatile ("l.nios_rrr %[out1],%[in1],r0,0xD":[out1]"=r"(result):[in1]"r"(rgb));

        grayscale[line*camParams.nrOfPixelsPerLine+pixel] = result;
